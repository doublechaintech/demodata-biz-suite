<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.candidateelement.CandidateElement'%>
...
<sky:include page="com/test/demodata/candidateelement/CandidateElement$Summary.jsp" />
...
<sky:include page="com/test/demodata/candidatecontainer/CandidateContainer$Info.jsp" />
