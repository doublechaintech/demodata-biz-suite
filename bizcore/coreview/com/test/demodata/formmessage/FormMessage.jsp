<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.formmessage.FormMessage'%>
...
<sky:include page="com/test/demodata/formmessage/FormMessage$Summary.jsp" />
