<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.wechatworkappidentify.WechatWorkappIdentify'%>
...
<sky:include page="com/test/demodata/wechatworkappidentify/WechatWorkappIdentify$Summary.jsp" />
