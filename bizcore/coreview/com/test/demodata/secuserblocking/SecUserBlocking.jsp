<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/test/demodata/secuserblocking/SecUserBlocking$Summary.jsp" />
