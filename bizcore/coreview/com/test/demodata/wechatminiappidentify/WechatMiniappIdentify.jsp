<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.wechatminiappidentify.WechatMiniappIdentify'%>
...
<sky:include page="com/test/demodata/wechatminiappidentify/WechatMiniappIdentify$Summary.jsp" />
