<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.candidatecontainer.CandidateContainer'%>
...
<sky:include page="com/test/demodata/candidatecontainer/CandidateContainer$Summary.jsp" />
		...
		<div id="candidateElementList" class="tab-pane fade sublist" refer-name="container">
			<sky:include page="com/test/demodata/candidateelement/CandidateElement$List.jsp"
					referName="container"/>
		</div>
	</c:if>
