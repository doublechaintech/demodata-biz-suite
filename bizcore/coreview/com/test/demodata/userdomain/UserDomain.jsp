<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.userdomain.UserDomain'%>
...
<sky:include page="com/test/demodata/userdomain/UserDomain$Summary.jsp" />
		...
		<div id="userWhiteListList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/test/demodata/userwhitelist/UserWhiteList$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/test/demodata/secuser/SecUser$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
