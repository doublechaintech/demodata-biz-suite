...
<div class="col-xs-12 col-md-12 section">
	<b title="A Image"> 
		${userContext.localeMap['image']}${userContext.localeMap['@word_space']}${userContext.localeMap['@summary']}
		</b>
...
<span class="summary-label">${userContext.localeMap['image.id']}</span>
<span >${result.id}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['image.name']}</span>
