<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.image.Image'%>
...
<c:set var="ownerBeanName" value="image" scope="request"/>
<c:set var="ownerClassName" value="Image" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="image" value="${ result}" scope="request" />
<sky:include page="com/test/demodata/image/Image$Summary.jsp" />
