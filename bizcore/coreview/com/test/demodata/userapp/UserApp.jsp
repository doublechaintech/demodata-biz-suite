<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.userapp.UserApp'%>
...
<sky:include page="com/test/demodata/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/test/demodata/secuser/SecUser$Info.jsp" />
		...
		<div id="quickLinkList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/test/demodata/quicklink/QuickLink$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["listAccessList"] or ignoreListAccessControl}'>
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/test/demodata/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/test/demodata/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
