<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.formfieldmessage.FormFieldMessage'%>
...
<sky:include page="com/test/demodata/formfieldmessage/FormFieldMessage$Summary.jsp" />
...
<sky:include page="com/test/demodata/genericform/GenericForm$Info.jsp" />
