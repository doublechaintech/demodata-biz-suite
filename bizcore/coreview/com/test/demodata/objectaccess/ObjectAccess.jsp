<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.objectaccess.ObjectAccess'%>
...
<sky:include page="com/test/demodata/objectaccess/ObjectAccess$Summary.jsp" />
...
<sky:include page="com/test/demodata/userapp/UserApp$Info.jsp" />
