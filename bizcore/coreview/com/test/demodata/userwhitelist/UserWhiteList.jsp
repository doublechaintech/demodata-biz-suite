<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/test/demodata/userwhitelist/UserWhiteList$Summary.jsp" />
