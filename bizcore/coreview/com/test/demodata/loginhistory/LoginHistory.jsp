<%@ page import='java.util.*,com.test.demodata.*,com.test.demodata.loginhistory.LoginHistory'%>
...
<sky:include page="com/test/demodata/loginhistory/LoginHistory$Summary.jsp" />
