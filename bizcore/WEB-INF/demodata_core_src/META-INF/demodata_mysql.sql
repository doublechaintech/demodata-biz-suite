...
insert into image_data values ('I000001','demo image','https://demo.doublechaintech.com/demodata/imageManager/genImage/banner000000/300/100/red/','2019-02-11 11:56:48','P000001','1');
insert into image_data values ('I000002','demo image0002','https://demo.doublechaintech.com/demodata/imageManager/genImage/banner000000/300/100/red/','2019-02-04 04:37:33','P000001','1');
...
insert into sec_user_data values ('SU000001','login','13900000001','','C183EC89F92A462CF45B95504792EC4625E847C90536EEFE512D1C9DB8602E95','0','2019-02-01 19:11:53','2019-01-24 20:35:30','UD000001',NULL,'BLOCKED','1');
insert into sec_user_data values ('SU000002','login0002','13900000002','suddy_chang@163.com','AC2F95628244C6975EB2C36942EA879ED93D93F5895EF3157733E4629FA86B92','9999999','2019-01-25 04:02:52','2019-02-08 23:43:36','UD000001',NULL,'BLOCKED0002','1');

	
insert into sec_user_blocking_data values ('SUB000001','currentUser()','2019-02-10 18:35:17','这个用户多次发送违反社区的帖子，现在把他给屏蔽了','1');
...
insert into login_history_data values ('LH000001','2019-02-08 00:16:17','192.168.1.1','登陆成功','SU000001','1');
insert into login_history_data values ('LH000002','2019-02-01 11:12:18','192.168.1.2','登陆成功0002','SU000001','1');
insert into login_history_data values ('LH000003','2019-02-03 21:00:40','192.168.1.1','登陆成功0003','SU000002','1');
insert into login_history_data values ('LH000004','2019-01-31 12:36:00','192.168.1.2','登陆成功0004','SU000002','1');
...
create unique index idx_image_version on image_data(id, version);

alter table image_data add constraint image4platform_fk
...
create index image4create_time_idx on image_data(create_time);
create index image4version_idx on image_data(version);
