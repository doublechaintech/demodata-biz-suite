...
public class DemodataChecker extends BaseChecker{
	...
	public DemodataChecker checkIdOfImage(String id)
	{
	 	...
	 	checkStringLengthRange(id,5, 64,ID_OF_IMAGE ); 		
	...
	public DemodataChecker checkIdOfSecUserBlocking(String id)
	{
	...
	public DemodataChecker checkWhoOfSecUserBlocking(String who)
	{
	...
	public DemodataChecker checkCommentsOfSecUserBlocking(String comments)
	{
	...
	public DemodataChecker checkVersionOfSecUserBlocking(int version)
	{
