...
public class DemodataUserContextImpl extends UserContextImpl implements DemodataUserContext{
    ...
    /*
    public static SecUser getSecUser(DemodataUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(DemodataUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(DemodataUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(DemodataUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
