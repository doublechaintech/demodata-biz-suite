...
public class ObjectAccessTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_OBJECT_TYPE,COLUMN_LIST1,COLUMN_LIST2,COLUMN_LIST3,COLUMN_LIST4,COLUMN_LIST5,COLUMN_LIST6,COLUMN_LIST7,COLUMN_LIST8,COLUMN_LIST9,COLUMN_APP,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_OBJECT_TYPE,COLUMN_LIST1,COLUMN_LIST2,COLUMN_LIST3,COLUMN_LIST4,COLUMN_LIST5,COLUMN_LIST6,COLUMN_LIST7,COLUMN_LIST8,COLUMN_LIST9,COLUMN_APP};
