...
public class ObjectAccessManagerImpl extends CustomDemodataCheckerManager implements ObjectAccessManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws ObjectAccessManagerException{
 	...
 	protected ObjectAccess saveObjectAccessDetail(DemodataUserContext userContext, ObjectAccess objectAccess) throws Exception{	
 	...
 	protected ObjectAccess present(DemodataUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ObjectAccess loadObjectAccessDetail(DemodataUserContext userContext, String objectAccessId) throws Exception{	
 	...
 	public Object view(DemodataUserContext userContext, String objectAccessId) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
