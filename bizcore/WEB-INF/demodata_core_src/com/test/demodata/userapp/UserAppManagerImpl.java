...
public class UserAppManagerImpl extends CustomDemodataCheckerManager implements UserAppManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws UserAppManagerException{
 	...
 	protected UserApp saveUserAppDetail(DemodataUserContext userContext, UserApp userApp) throws Exception{	
 	...
 	protected UserApp present(DemodataUserContext userContext, UserApp userApp, Map<String, Object> tokens) throws Exception {
 	...
 	public UserApp loadUserAppDetail(DemodataUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, allTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	
 	public Object view(DemodataUserContext userContext, String userAppId) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, UserApp userApp, Map<String, Object> tokens){
