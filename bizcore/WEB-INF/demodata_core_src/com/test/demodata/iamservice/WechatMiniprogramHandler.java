...
public class WechatMiniprogramHandler extends BaseIdentificationHandler {
	...
	@Override
	public LoginResult authenticate(DemodataUserContext userContext, LoginContext loginContext) {
	...
	protected boolean authenticateWithCode(DemodataUserContext userContext, String code, LoginResult result) throws Exception{
	...
	@Override
	public void bindWithSecUser(DemodataUserContext userContext, LoginContext loginContext) throws Exception {
	...
	protected SmartList<WechatMiniappIdentify> getIdentifyRecords(DemodataUserContext userContext,
