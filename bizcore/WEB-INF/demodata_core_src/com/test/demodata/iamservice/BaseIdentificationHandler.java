...
public abstract class BaseIdentificationHandler implements IdentificationHandler{
	...
	protected String getVeriyCodeCacheKey(DemodataUserContext userContext, String mobile) {
		return String.format("vcode:%s:%s", mobile, userContext.tokenId());
	}

	protected String getWehatSessionKeyCacheKey(DemodataUserContext userContext, String appId, String openId) {
