...
// import com.test.demodata.DemodataBizUserContextImpl;
...
public abstract class BaseIamService {
	...
	public LoginResult doLogin(DemodataUserContextImpl userContext, LoginContext loginContext, BusinessHandler bizHandler) throws Exception {
	 ...
	 * @throws Exception 
	 */
	protected void onAuthenticateNewUserLogged(DemodataUserContextImpl userContext, LoginContext loginContext,
	 ...
	 * 
	 */
	protected void onAuthenticateUserLogged(DemodataUserContextImpl userContext, LoginContext loginContext,
			LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler) throws Exception {
		// 回调业务
	...
	// 为兼容旧版本secUser登录接口
	public void onLoginSecUserInternalSuccess(DemodataUserContextImpl userContext, SecUser user) {
		String tokenKey = userContext.tokenId();
		// 生成 jwtToken
	 ...
	 */
	protected boolean isLoginClientSupportSession(DemodataUserContextImpl userContext, LoginContext loginContext,
	 ...
	 */
	protected void onAuthenticationFailed(DemodataUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
	 ...
	 * @return
	 */
	protected IdentificationHandler selectIdentificationHandler(DemodataUserContextImpl userContext, LoginContext loginContext) {
		if (idHandlers == null) {
	...
	protected String getLoginInfoCacheKey(DemodataUserContextImpl userContext) {
		return this.getCacheKey(userContext, "loginInfo");
	}
	protected String getJwtTokenCacheKey(DemodataUserContextImpl userContext) {
		return this.getCacheKey(userContext, "jwtToken");
	}
	
	// 获取token key的优先级为: jwtToken->cookie->session id
	public String getTokenKey(DemodataUserContextImpl userContext) {
	...
	protected void cacheJwtToken(DemodataUserContextImpl userContext, DecodedJWT jwtToken) {
		userContext.putIntoContextLocalStorage(getJwtTokenCacheKey(userContext), jwtToken);
	}
	protected DecodedJWT getCachedJwtToken(DemodataUserContextImpl userContext) {
		return (DecodedJWT) userContext.getFromContextLocalStorage(getJwtTokenCacheKey(userContext));
	}
	
	protected DecodedJWT getJwtTokenFromCookie(DemodataUserContextImpl userContext) {
	...
	protected DecodedJWT getJwtTokenFromHeader(DemodataUserContextImpl userContext) {
	...
	public Map<String, Object> getCachedLoginInfo(DemodataUserContextImpl userContext) {
	...
	protected String getCacheKey(UserContext userContext, String prefix){
		return "demodata:"+prefix+":"+userContext.tokenId();
	}
	...
	protected void fixUserContextTokenId(DemodataUserContextImpl userContext, String tokenKey) {
		if (!userContext.tokenId().equals(tokenKey)) {
			userContext.setTokenId(tokenKey);
		}
	}
	public SecUser tryToLoadSecUser(DemodataUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
	...
	public UserApp tryToLoadUserApp(DemodataUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
...
//	
//	
//	protected boolean onSecUserNotFoundWhenCheckAccess(DemodataUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return false;
//	}
//	protected boolean onSecUserFoundWhenCheckAccess(DemodataUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected boolean onSecUserAppFoundWhenCheckAccess(DemodataUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected SecUser tryToLoadSecUser(DemodataUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//		String secUserId = (String) loginInfo.get("secUser");
...
//		}
//	}
//	protected UserApp tryToLoadUserApp(DemodataUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//		
...
//	
//	
//	public Object exampleLoginByAccountPassword(DemodataUserContextImpl userContext, String acct, String password) throws Exception {
//		
//		BusinessHandler bizHandler = new BusinessHandler() {
//			public void onAuthenticationFailed(DemodataUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onFailExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateNewUserLogged(DemodataUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onNewExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateUserLogged(DemodataUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
...
//	}
//	
//	protected Object onFailExample(DemodataUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// TODO Auto-generated method stub
//		return null;
//	}
//	protected Object onNewExample(DemodataUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 新用户来了,我也不知道该干嘛,所以报错
...
//		return null;
//	}
//	protected Object onSuccessExample(DemodataUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 成功了就直接记载第一个userApp
//		SecUser secUser = loginResult.getLoginContext().getLoginTarget().getSecUser();
