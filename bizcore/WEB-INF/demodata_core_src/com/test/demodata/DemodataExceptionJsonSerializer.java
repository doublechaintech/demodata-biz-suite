...
public class DemodataExceptionJsonSerializer extends  JsonSerializer<DemodataException> {
	...
	@Override
	public void serialize(DemodataException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, DemodataException exception,
	...
	protected void writeStartObject(DemodataException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(DemodataException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,DemodataException exception,
	...
	protected void writeMessageList(String fieldName,DemodataException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
