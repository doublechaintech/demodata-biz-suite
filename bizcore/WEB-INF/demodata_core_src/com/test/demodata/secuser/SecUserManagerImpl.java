...
import com.test.demodata.userdomain.CandidateUserDomain;
...
public class SecUserManagerImpl extends CustomDemodataCheckerManager implements SecUserManager, BusinessHandler{
	...
	@Override
	public SecUserDAO daoOf(DemodataUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserManagerException{
 	...
 	protected SecUser saveSecUser(DemodataUserContext userContext, SecUser secUser, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUser saveSecUserDetail(DemodataUserContext userContext, SecUser secUser) throws Exception{	
 	...
 	public SecUser loadSecUser(DemodataUserContext userContext, String secUserId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUser searchSecUser(DemodataUserContext userContext, String secUserId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUser present(DemodataUserContext userContext, SecUser secUser, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUser loadSecUserDetail(DemodataUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, allTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	
 	public Object view(DemodataUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, viewTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	protected SecUser saveSecUser(DemodataUserContext userContext, SecUser secUser, Map<String,Object>tokens) throws Exception{	
 		return secUserDaoOf(userContext).save(secUser, tokens);
 	}
 	protected SecUser loadSecUser(DemodataUserContext userContext, String secUserId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSecUser(secUserId);
		checkerOf(userContext).throwExceptionIfHasErrors( SecUserManagerException.class);
	...
	public SecUser loadSecUserWithMobile(DemodataUserContext userContext, String mobile, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUser(DemodataUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUser clone(DemodataUserContext userContext, String fromSecUserId) throws Exception{
	...
	public SecUser internalSaveSecUser(DemodataUserContext userContext, SecUser secUser, Map<String,Object> options) throws Exception
	{
	...
	public SecUser updateSecUserProperty(DemodataUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSecUser(userContext, secUserId, secUserVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(DemodataUserContext userContext, String secUserId, String anotherDomainId) throws Exception
 	{
	...
	public CandidateUserDomain requestCandidateDomain(DemodataUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected UserDomain loadUserDomain(DemodataUserContext userContext, String newDomainId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(DemodataUserContext userContext, String secUserId, int secUserVersion) throws Exception {
	...
	public SecUser forgetByAll(DemodataUserContext userContext, String secUserId, int secUserVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserId, secUserVersion);
	}
	protected SecUser forgetByAllInternal(DemodataUserContext userContext,
			String secUserId, int secUserVersion) throws Exception{
	...
	protected SecUser breakWithUserAppByObjectId(DemodataUserContext userContext, String secUserId, String objectIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SecUser breakWithWechatWorkappIdentifyByCorpId(DemodataUserContext userContext, String secUserId, String corpIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SecUser breakWithWechatWorkappIdentifyByUserId(DemodataUserContext userContext, String secUserId, String userIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SecUser breakWithWechatMiniappIdentifyByOpenId(DemodataUserContext userContext, String secUserId, String openIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SecUser breakWithWechatMiniappIdentifyByAppId(DemodataUserContext userContext, String secUserId, String appIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingUserApp(DemodataUserContext userContext, String secUserId, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserAppProperties(DemodataUserContext userContext, String secUserId,String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateUserAppProperties(DemodataUserContext userContext, String secUserId, String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location, String [] tokensExpr) throws Exception
	{
	...
	protected UserApp createUserApp(DemodataUserContext userContext, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location) throws Exception{
	...
	protected void checkParamsForRemovingUserAppList(DemodataUserContext userContext, String secUserId,
	...
	public  SecUser removeUserAppList(DemodataUserContext userContext, String secUserId,
			String userAppIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserApp(DemodataUserContext userContext, String secUserId,
	...
	public  SecUser removeUserApp(DemodataUserContext userContext, String secUserId,
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserApp(DemodataUserContext userContext, String secUserId,
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyUserAppFrom(DemodataUserContext userContext, String secUserId,
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserApp(DemodataUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateUserApp(DemodataUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingLoginHistory(DemodataUserContext userContext, String secUserId, String fromIp, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistoryProperties(DemodataUserContext userContext, String secUserId,String id,String fromIp,String description,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateLoginHistoryProperties(DemodataUserContext userContext, String secUserId, String id,String fromIp,String description, String [] tokensExpr) throws Exception
	{
	...
	protected LoginHistory createLoginHistory(DemodataUserContext userContext, String fromIp, String description) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistoryList(DemodataUserContext userContext, String secUserId,
	...
	public  SecUser removeLoginHistoryList(DemodataUserContext userContext, String secUserId,
			String loginHistoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistory(DemodataUserContext userContext, String secUserId,
	...
	public  SecUser removeLoginHistory(DemodataUserContext userContext, String secUserId,
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLoginHistory(DemodataUserContext userContext, String secUserId,
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyLoginHistoryFrom(DemodataUserContext userContext, String secUserId,
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistory(DemodataUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateLoginHistory(DemodataUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingWechatWorkappIdentify(DemodataUserContext userContext, String secUserId, String corpId, String userId, DateTime lastLoginTime,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWechatWorkappIdentifyProperties(DemodataUserContext userContext, String secUserId,String id,String corpId,String userId,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateWechatWorkappIdentifyProperties(DemodataUserContext userContext, String secUserId, String id,String corpId,String userId,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{
	...
	protected WechatWorkappIdentify createWechatWorkappIdentify(DemodataUserContext userContext, String corpId, String userId, DateTime lastLoginTime) throws Exception{
	...
	protected void checkParamsForRemovingWechatWorkappIdentifyList(DemodataUserContext userContext, String secUserId,
	...
	public  SecUser removeWechatWorkappIdentifyList(DemodataUserContext userContext, String secUserId,
			String wechatWorkappIdentifyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingWechatWorkappIdentify(DemodataUserContext userContext, String secUserId,
	...
	public  SecUser removeWechatWorkappIdentify(DemodataUserContext userContext, String secUserId,
		String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingWechatWorkappIdentify(DemodataUserContext userContext, String secUserId,
		String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyWechatWorkappIdentifyFrom(DemodataUserContext userContext, String secUserId,
		String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWechatWorkappIdentify(DemodataUserContext userContext, String secUserId, String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateWechatWorkappIdentify(DemodataUserContext userContext, String secUserId, String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingWechatMiniappIdentify(DemodataUserContext userContext, String secUserId, String openId, String appId, DateTime lastLoginTime,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWechatMiniappIdentifyProperties(DemodataUserContext userContext, String secUserId,String id,String openId,String appId,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateWechatMiniappIdentifyProperties(DemodataUserContext userContext, String secUserId, String id,String openId,String appId,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{
	...
	protected WechatMiniappIdentify createWechatMiniappIdentify(DemodataUserContext userContext, String openId, String appId, DateTime lastLoginTime) throws Exception{
	...
	protected void checkParamsForRemovingWechatMiniappIdentifyList(DemodataUserContext userContext, String secUserId,
	...
	public  SecUser removeWechatMiniappIdentifyList(DemodataUserContext userContext, String secUserId,
			String wechatMiniappIdentifyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingWechatMiniappIdentify(DemodataUserContext userContext, String secUserId,
	...
	public  SecUser removeWechatMiniappIdentify(DemodataUserContext userContext, String secUserId,
		String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingWechatMiniappIdentify(DemodataUserContext userContext, String secUserId,
		String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyWechatMiniappIdentifyFrom(DemodataUserContext userContext, String secUserId,
		String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWechatMiniappIdentify(DemodataUserContext userContext, String secUserId, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateWechatMiniappIdentify(DemodataUserContext userContext, String secUserId, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(DemodataUserContext userContext,SmartList<SecUser> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<UserDomain> domainList = DemodataBaseUtils.collectReferencedObjectWithType(userContext, list, UserDomain.class);
