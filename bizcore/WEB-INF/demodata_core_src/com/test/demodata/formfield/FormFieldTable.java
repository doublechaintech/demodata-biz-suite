...
public class FormFieldTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_LABEL,COLUMN_LOCALE_KEY,COLUMN_PARAMETER_NAME,COLUMN_TYPE,COLUMN_FORM,COLUMN_PLACEHOLDER,COLUMN_DEFAULT_VALUE,COLUMN_DESCRIPTION,COLUMN_FIELD_GROUP,COLUMN_MINIMUM_VALUE,COLUMN_MAXIMUM_VALUE,COLUMN_REQUIRED,COLUMN_DISABLED,COLUMN_CUSTOM_RENDERING,COLUMN_CANDIDATE_VALUES,COLUMN_SUGGEST_VALUES,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_LABEL,COLUMN_LOCALE_KEY,COLUMN_PARAMETER_NAME,COLUMN_TYPE,COLUMN_FORM,COLUMN_PLACEHOLDER,COLUMN_DEFAULT_VALUE,COLUMN_DESCRIPTION,COLUMN_FIELD_GROUP,COLUMN_MINIMUM_VALUE,COLUMN_MAXIMUM_VALUE,COLUMN_REQUIRED,COLUMN_DISABLED,COLUMN_CUSTOM_RENDERING,COLUMN_CANDIDATE_VALUES,COLUMN_SUGGEST_VALUES};
