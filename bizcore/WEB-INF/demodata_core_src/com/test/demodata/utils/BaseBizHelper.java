package com.test.demodata.utils;
...
public class BaseBizHelper {
	protected CustomDemodataUserContextImpl userContext;
	protected static final Map<String, Object> EO = new HashMap<>();
	protected Map<String, Object> cache;
	
	public CustomDemodataUserContextImpl getUserContext() {
		return userContext;
	}
	public void setUserContext(CustomDemodataUserContextImpl userContext) {
		this.userContext = userContext;
	}

	protected static <T extends BaseBizHelper> T _OF(CustomDemodataUserContextImpl ctx, Class<T> clazz) {
		return _OF(ctx, clazz, false);
	}
			
	protected static <T extends BaseBizHelper> T _OF(CustomDemodataUserContextImpl ctx,
