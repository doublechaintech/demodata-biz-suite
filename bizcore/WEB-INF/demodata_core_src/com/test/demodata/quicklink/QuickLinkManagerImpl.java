...
public class QuickLinkManagerImpl extends CustomDemodataCheckerManager implements QuickLinkManager, BusinessHandler{
	...
	@Override
	public QuickLinkDAO daoOf(DemodataUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws QuickLinkManagerException{
 	...
 	protected QuickLink saveQuickLink(DemodataUserContext userContext, QuickLink quickLink, String [] tokensExpr) throws Exception{	
 	...
 	protected QuickLink saveQuickLinkDetail(DemodataUserContext userContext, QuickLink quickLink) throws Exception{	
 	...
 	public QuickLink loadQuickLink(DemodataUserContext userContext, String quickLinkId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public QuickLink searchQuickLink(DemodataUserContext userContext, String quickLinkId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected QuickLink present(DemodataUserContext userContext, QuickLink quickLink, Map<String, Object> tokens) throws Exception {
 	...
 	public QuickLink loadQuickLinkDetail(DemodataUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, allTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	
 	public Object view(DemodataUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, viewTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	protected QuickLink saveQuickLink(DemodataUserContext userContext, QuickLink quickLink, Map<String,Object>tokens) throws Exception{	
 		return quickLinkDaoOf(userContext).save(quickLink, tokens);
 	}
 	protected QuickLink loadQuickLink(DemodataUserContext userContext, String quickLinkId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfQuickLink(quickLinkId);
		checkerOf(userContext).throwExceptionIfHasErrors( QuickLinkManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingQuickLink(DemodataUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public QuickLink clone(DemodataUserContext userContext, String fromQuickLinkId) throws Exception{
	...
	public QuickLink internalSaveQuickLink(DemodataUserContext userContext, QuickLink quickLink, Map<String,Object> options) throws Exception
	{
	...
	public QuickLink updateQuickLinkProperty(DemodataUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingQuickLink(userContext, quickLinkId, quickLinkVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(DemodataUserContext userContext, String quickLinkId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(DemodataUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
	...
	public QuickLink forgetByAll(DemodataUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
		return forgetByAllInternal(userContext, quickLinkId, quickLinkVersion);
	}
	protected QuickLink forgetByAllInternal(DemodataUserContext userContext,
			String quickLinkId, int quickLinkVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(DemodataUserContext userContext,SmartList<QuickLink> list) throws Exception {
