...
public class FormActionTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_LABEL,COLUMN_LOCALE_KEY,COLUMN_ACTION_KEY,COLUMN_LEVEL,COLUMN_URL,COLUMN_FORM,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_LABEL,COLUMN_LOCALE_KEY,COLUMN_ACTION_KEY,COLUMN_LEVEL,COLUMN_URL,COLUMN_FORM};
