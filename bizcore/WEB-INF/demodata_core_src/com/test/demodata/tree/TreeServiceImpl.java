...
public class TreeServiceImpl extends CustomDemodataCheckerManager implements TreeService {

    @Override
    public Node loadTree(DemodataUserContext ctx, String nodeId, String nodeType) throws Exception {
    ...
    @Override
    public Node loadAncestors(DemodataUserContext ctx, String nodeId, String nodeType) throws Exception {
        SmartList<TreeNode> nodes = loadTreeNode(ctx, nodeId, nodeType);
    ...
    public SmartList<TreeNode> loadTreeNode(DemodataUserContext ctx, String nodeId, String nodeType) {
     ...
     * @throws Exception
     */
    private <T extends BaseEntity> Node<T> extractTreeFromRoot(DemodataUserContext ctx, TreeNode pRoot) throws Exception {
    ...
    private <T extends BaseEntity> Node<T> extractAncestors(DemodataUserContext ctx, TreeNode pNode) throws Exception {
    ...
    @Override
    public Node addChild(DemodataUserContext ctx, Node nodeTree, String childId, String childType) throws Exception {
    ...
    public Node ensureRoot(DemodataUserContext ctx) throws Exception {
    ...
    @Override
    public Node deleteChild(DemodataUserContext ctx, Node parent, Node child) throws Exception {
        //do nothing
    ...
    private Node buildInternalTree(DemodataUserContext ctx, final List<TreeNode> pTreeNodes) throws Exception {
        ...
        for (TreeNode node : treeNodeList) {
            ...
            BaseEntity item = typeItems.get(nodeType).get(nodeId);
