...
public class UserDomainManagerImpl extends CustomDemodataCheckerManager implements UserDomainManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws UserDomainManagerException{
 	...
 	protected UserDomain saveUserDomainDetail(DemodataUserContext userContext, UserDomain userDomain) throws Exception{	
 	...
 	protected UserDomain present(DemodataUserContext userContext, UserDomain userDomain, Map<String, Object> tokens) throws Exception {
 	...
 	public UserDomain loadUserDomainDetail(DemodataUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, allTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	
 	public Object view(DemodataUserContext userContext, String userDomainId) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
