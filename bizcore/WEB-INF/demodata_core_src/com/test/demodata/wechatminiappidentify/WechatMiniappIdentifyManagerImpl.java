...
public class WechatMiniappIdentifyManagerImpl extends CustomDemodataCheckerManager implements WechatMiniappIdentifyManager, BusinessHandler{
	...
	@Override
	public WechatMiniappIdentifyDAO daoOf(DemodataUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws WechatMiniappIdentifyManagerException{
 	...
 	protected WechatMiniappIdentify saveWechatMiniappIdentify(DemodataUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, String [] tokensExpr) throws Exception{	
 	...
 	protected WechatMiniappIdentify saveWechatMiniappIdentifyDetail(DemodataUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify) throws Exception{	
 	...
 	public WechatMiniappIdentify loadWechatMiniappIdentify(DemodataUserContext userContext, String wechatMiniappIdentifyId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public WechatMiniappIdentify searchWechatMiniappIdentify(DemodataUserContext userContext, String wechatMiniappIdentifyId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected WechatMiniappIdentify present(DemodataUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String, Object> tokens) throws Exception {
 	...
 	public WechatMiniappIdentify loadWechatMiniappIdentifyDetail(DemodataUserContext userContext, String wechatMiniappIdentifyId) throws Exception{	
 	...
 	public Object view(DemodataUserContext userContext, String wechatMiniappIdentifyId) throws Exception{	
 		WechatMiniappIdentify wechatMiniappIdentify = loadWechatMiniappIdentify( userContext, wechatMiniappIdentifyId, viewTokens());
 		return present(userContext,wechatMiniappIdentify, allTokens());
		
 	}
 	protected WechatMiniappIdentify saveWechatMiniappIdentify(DemodataUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String,Object>tokens) throws Exception{	
 		return wechatMiniappIdentifyDaoOf(userContext).save(wechatMiniappIdentify, tokens);
 	}
 	protected WechatMiniappIdentify loadWechatMiniappIdentify(DemodataUserContext userContext, String wechatMiniappIdentifyId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfWechatMiniappIdentify(wechatMiniappIdentifyId);
		checkerOf(userContext).throwExceptionIfHasErrors( WechatMiniappIdentifyManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(DemodataUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingWechatMiniappIdentify(DemodataUserContext userContext,String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public WechatMiniappIdentify clone(DemodataUserContext userContext, String fromWechatMiniappIdentifyId) throws Exception{
	...
	public WechatMiniappIdentify internalSaveWechatMiniappIdentify(DemodataUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String,Object> options) throws Exception
	{
	...
	public WechatMiniappIdentify updateWechatMiniappIdentifyProperty(DemodataUserContext userContext,String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingWechatMiniappIdentify(userContext, wechatMiniappIdentifyId, wechatMiniappIdentifyVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(DemodataUserContext userContext, String wechatMiniappIdentifyId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(DemodataUserContext userContext, String wechatMiniappIdentifyId, String anotherLogin) throws Exception
 	{
 	...
 	public WechatMiniappIdentify transferToAnotherSecUserWithLogin(DemodataUserContext userContext, String wechatMiniappIdentifyId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(DemodataUserContext userContext, String wechatMiniappIdentifyId, String anotherEmail) throws Exception
 	{
 	...
 	public WechatMiniappIdentify transferToAnotherSecUserWithEmail(DemodataUserContext userContext, String wechatMiniappIdentifyId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(DemodataUserContext userContext, String wechatMiniappIdentifyId, String anotherMobile) throws Exception
 	{
 	...
 	public WechatMiniappIdentify transferToAnotherSecUserWithMobile(DemodataUserContext userContext, String wechatMiniappIdentifyId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(DemodataUserContext userContext, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion) throws Exception {
	...
	public WechatMiniappIdentify forgetByAll(DemodataUserContext userContext, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion) throws Exception {
		return forgetByAllInternal(userContext, wechatMiniappIdentifyId, wechatMiniappIdentifyVersion);
	}
	protected WechatMiniappIdentify forgetByAllInternal(DemodataUserContext userContext,
			String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(DemodataUserContext userContext,SmartList<WechatMiniappIdentify> list) throws Exception {
