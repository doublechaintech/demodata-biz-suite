...
public class BaseChecker {
	...
	public void setUserContext(DemodataUserContext ctx) {
	...
	// for stub only
	protected void checkDateNow(Date likeTime, int i, Object now, String targetFieldName, Exception exception) {
