...
import com.test.demodata.LoginForm;
import com.test.demodata.BaseEntity;
import com.test.demodata.CommonError;
import com.test.demodata.DAOGroup;
import com.test.demodata.ManagerGroup;

import com.test.demodata.UserContextImpl;
import com.test.demodata.userapp.UserApp;
import com.test.demodata.DemodataUserContext;
import com.test.demodata.userapp.*;
import com.test.demodata.listaccess.*;
import com.test.demodata.objectaccess.*;
import com.test.demodata.DemodataObjectChecker;
import com.test.demodata.loginhistory.LoginHistory;
import com.test.demodata.Message;
import com.test.demodata.CustomDemodataUserContextImpl;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
   ...
   public void setBlockChainAdvancer(BlockChainAdvancer pBlockChainAdvancer){
    ...
    public String confirmSession(DemodataUserContext userContext){
    ...
    public Object resetPassword(DemodataUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(DemodataUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(DemodataUserContext userContext,
    ...
    public SecUser manage(DemodataUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(DemodataUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }

    public SecUser getCachedSecUser(DemodataUserContext userContext) {
    ...
    protected Object gotoApp(DemodataUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(DemodataUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(DemodataUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(DemodataUserContext userContex, int length){
    ...
    protected String getBeanName(DemodataUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(DemodataUserContext userContext, UserApp app){

        return  app.getObjectId();

    }
    protected String getServiceType(DemodataUserContext userContext, UserApp app){

        return app.getObjectType();
    }
    protected String getMethodName(DemodataUserContext userContext, UserApp app){
    ...
    public Object home(DemodataUserContext userContext) {
    ...
    public Object loginWithEmail(DemodataUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);

    }
    public Object login(DemodataUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(DemodataUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);

    }
    public Object loginWithMobile(DemodataUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);

    }
    protected SecUser loadUserWith(DemodataUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(DemodataUserContext userContext, String type, String userId,
            Password password) {
     ...
     */
    protected Object loginTheSecUserInternal(DemodataUserContext userContext, SecUser user, String loginComments) throws Exception {
		...
		iamService.onLoginSecUserInternalSuccess((DemodataUserContextImpl) userContext, user);
    ...
    public Object showlogin(DemodataUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(DemodataUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        DemodataUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected DemodataObjectChecker checker;
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((DemodataObjectChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected DemodataUserContextImpl createNewConext(String path) {

        return new CustomDemodataUserContextImpl();
    ...
    public Object checkOtherLogin(DemodataUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(DemodataUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(DemodataUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(DemodataUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(DemodataUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(DemodataUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(DemodataUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(DemodataUserContext userContext) throws SecUserManagerException {
