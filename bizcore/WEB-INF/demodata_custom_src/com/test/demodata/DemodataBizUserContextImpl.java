...
public class DemodataBizUserContextImpl extends DemodataUserContextImpl{
	...
	protected BaseDemodataFormProcessor inputFormData;
	protected BaseDemodataFormProcessor outputFormData;
	...
	public String getPostMd5Key(DemodataBizUserContextImpl ctx) {
	...
	public BaseDemodataFormProcessor getInputFormData() {
		return inputFormData;
	}
	public void setInputFormData(BaseDemodataFormProcessor inputFormData) {
		this.inputFormData = inputFormData;
	}
	public BaseDemodataFormProcessor getOutputFormData() {
		return outputFormData;
	}
	public void setOutputFormData(BaseDemodataFormProcessor outputFormData) {
