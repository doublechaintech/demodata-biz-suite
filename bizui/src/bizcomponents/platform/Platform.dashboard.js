...
class PlatformDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const { id,displayName, imageListMetaInfo, imageCount } = this.props.platform
    ...
    const cardsData = {cardsName:"Platform",cardsFor: "platform",
    	cardsSource: this.props.platform,returnURL,displayName,
  		subItems: [
{name: 'imageList', displayName:'Image',type:'image',count:imageCount,addFunction: true, role: 'image', metaInfo: imageListMetaInfo},
