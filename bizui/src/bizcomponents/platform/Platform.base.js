...
const menuData = {menuName:"Platform", menuFor: "platform",
  		subItems: [
  {name: 'imageList', displayName:'Image', icon:'image',readPermission: false,createPermission: false,deletePermission: false,updatePermission: false,executionPermission: false},
...
const displayColumns = [
  ...
  { title: 'Name', debugtype: 'string', dataIndex: 'name', width: '21',render: (text, record)=>renderTextCell(text,record) },
