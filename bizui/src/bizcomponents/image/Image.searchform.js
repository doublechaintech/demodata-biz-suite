...
class ImageSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      imageList: 1,
      'imageList.searchField': fieldName,
      'imageList.searchVerb': 'startsWith',
      'imageList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`imageList.searchField`] = fieldName
    value[`imageList.searchVerb`] =  searchVerb
    value[`imageList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['imageList'] = 1
      params['imageList.orderBy.0'] = "id"
      params['imageList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        imageSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={ImageService.requestCandidatePlatform}/>
...
export default Form.create()(ImageSearchForm)
