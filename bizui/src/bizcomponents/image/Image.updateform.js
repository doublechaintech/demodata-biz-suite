...
import styles from './Image.updateform.less'
...
class ImageUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, imageId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextImageUpdateRow`,
        payload: {
          id: owner.id,
          type: 'image',
          selectedRows,
