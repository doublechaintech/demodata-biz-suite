...
import ImageBase from './image/Image.base';
import ImageBizApp from './image/Image.app';
import ImageModel from './image/Image.model';
import ImageDashboard from './image/Image.dashboard';
import ImagePreference from './image/Image.preference';
import ImageModalTable from './image/Image.modaltable';
import ImageSearch from './image/Image.search';
import ImageSearchForm from './image/Image.searchform';
import ImageCreateForm from './image/Image.createform';
import ImageAssociateForm from './image/Image.associateform';
import ImageTable from './image/Image.table';
import ImageService from './image/Image.service';
import ImageUpdateForm from './image/Image.updateform';
...
menuLibrary['image'] = ImageBase.menuData
...
const ViewMapping = {
  ...
  'com.test.demodata.platform.Platform': {name:'platform'},
  'com.test.demodata.image.Image': {name:'image'},
  'com.test.demodata.userdomain.UserDomain': {name:'userDomain'},
  'com.test.demodata.userwhitelist.UserWhiteList': {name:'userWhiteList'},
  'com.test.demodata.secuser.SecUser': {name:'secUser'},
  'com.test.demodata.secuserblocking.SecUserBlocking': {name:'secUserBlocking'},
  'com.test.demodata.userapp.UserApp': {name:'userApp'},
  'com.test.demodata.listaccess.ListAccess': {name:'listAccess'},
  'com.test.demodata.objectaccess.ObjectAccess': {name:'objectAccess'},
  'com.test.demodata.loginhistory.LoginHistory': {name:'loginHistory'},
